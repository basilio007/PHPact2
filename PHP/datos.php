...
echo "El id del mueble es ".$id." su color es ".$color." tiene una dimension de ".$dimension." es de tipo "
.$tipo;

$servidor="localhost";
$usuario="basilio_alejandrro";
$password="4x9IAXVBxV7g]cUe";
$bd="muebles";
...
if(!$con){
    ...
    $sql="INSERT INTO `datos`(`ID` , `COLOR`, `DIMENSION`, `TIPO`, 'DNI', 'NOMBRE', 'DIRECCION', 'EMAIL') 
